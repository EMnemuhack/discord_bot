        ...
        if attack_index == common.ATTACK_MAIN:
            ...
            if current_lap_key in dic:
                ...
                for i in range(0, len(rs)):
                    # 予約があった場合は予約情報を保存　ブランチとは本凸か持ち越しか
